        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              const Text('Find hospitals, schools, software houses, factories, and any business near your location with a single tap.', textAlign: TextAlign.center, style: TextStyle(fontSize: 15, color: AppColors.textGray, height: 1.6)),
              const Spacer(),
              Row(
