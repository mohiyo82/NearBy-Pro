...
class _ResumeManagerScreenState extends State<ResumeManagerScreen> {
  final int _personalInfoCount = 1;
  final int _educationCount = 2;
  final int _experienceCount = 1;
  final int _skillsCount = 5;
  final int _resumeFileCount = 0;
  final int _portfolioCount = 1;
          ...
          children: [
            Container(
              ...
              decoration: BoxDecoration(
                ...
                boxShadow: [BoxShadow(color: AppColors.secondary.withValues(alpha: 0.3), blurRadius: 12, offset: const Offset(0, 6))],
              ),
