      ...
      body: ListView(
        ...
        children: [
          ...
          ...channels.map((c) => Container(
            ...
            child: Row(
              children: [
                Container(width: 44, height: 44, decoration: BoxDecoration(color: (c['color'] as Color).withValues(alpha: 0.1), borderRadius: BorderRadius.circular(12)), child: Icon(c['icon'] as IconData, color: c['color'] as Color, size: 22)),
