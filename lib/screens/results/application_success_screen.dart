          ...
          child: Column(
            ...
            children: [
              ...
              Container(
                width: 140,
                height: 140,
                decoration: BoxDecoration(color: AppColors.success.withValues(alpha: 0.1), shape: BoxShape.circle, border: Border.all(color: AppColors.success, width: 3)),
              ...
              Container(
                ...
                child: const Column(
                  children: [
                    Text('Application Reference', style: TextStyle(fontSize: 13, color: AppColors.textGray)),
                    SizedBox(height: 4),
                    Text('#APP-00000', style: TextStyle(fontSize: 20, fontWeight: FontWeight.w800, color: AppColors.primary, letterSpacing: 1)),
                    SizedBox(height: 16),
                    Divider(),
                    SizedBox(height: 12),
              ...
              OutlinedButton(
                ...
                child: const Text('Back to Home', style: TextStyle(color: AppColors.textDark, fontWeight: FontWeight.w600)),
              ),
              const SizedBox(height: 12),
              TextButton(onPressed: () => Navigator.pop(context), child: const Text('Find More Opportunities', style: TextStyle(color: AppColors.primary, fontWeight: FontWeight.w600))),
            ],
          ),
        ),
      ),
