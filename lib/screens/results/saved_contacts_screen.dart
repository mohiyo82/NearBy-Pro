              ...
              itemBuilder: (context, i) {
                ...
                return Container(
                  ...
                  child: ListTile(
                    ...
                    leading: Container(width: 48, height: 48, decoration: BoxDecoration(color: AppColors.primary.withValues(alpha: 0.1), borderRadius: BorderRadius.circular(12)), child: Icon(c['icon'] as IconData, color: AppColors.primary, size: 24)),
