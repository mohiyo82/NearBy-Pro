      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 14),
            const _QualRow(label: 'Education Level', required: 'Bachelor\'s Degree', yours: 'Not Set', match: false),
            const _QualRow(label: 'Experience', required: '1–3 Years', yours: '0 Years', match: false),
            const _QualRow(label: 'Location Match', required: 'Lahore', yours: 'Your City', match: false),
            const SizedBox(height: 24),
            ElevatedButton(onPressed: () => Navigator.pushNamed(context, '/application-success'), child: const Text('Proceed to Apply')),
            const SizedBox(height: 12),
            OutlinedButton(
